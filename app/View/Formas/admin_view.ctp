...
<h2><?php echo __('Forma'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($forma['Forma']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($forma['Forma']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Forma'), array('action' => 'edit', $forma['Forma']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Forma'), array('action' => 'delete', $forma['Forma']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $forma['Forma']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Formas'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Forma'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($forma['Producto'] as $producto): ?>
		<tr>
