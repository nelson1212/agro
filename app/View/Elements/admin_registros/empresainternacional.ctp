...
<div class="panel panel-default" id="divPanel"> <!-- PANEL -->
    <div class="panel-heading">
        <h3 class="panel-title"><b>Datos del usuario tipo empresa internacional </b></h3>
    </div>
    <div class="panel-body">
        <?php echo $this->Form->create('EmpresaInternacional', array('id' => "formEmpInt", 'type' => 'file', "novalidate" => "novalidate")); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <?php echo $this->Form->input('paiss_id', array("div" => false, "options" => $paises, "id" => "cboPaisEmpInt", "label" => "Pais *", 'tag' => 'paiss_id', "type" => "select", "class" => "form-control")); ?>
     ...
     dasdasd
        ...
        <div class="row"> 
            <div class="col-lg-4">
                <?php
                $options = array('label' => 'Guardar', 'type' => "submit", "id" => "btnGuaEmpIntNac", 'class' => 'btn btn-primary', 'div' => false);
                echo $this->Form->end($options);
                ?> 
                <?php
                $options = array('label' => 'Cancelar', "id" => "btnCanGuaEmpIntNac", 'class' => 'btn btn-warning', 'div' => false);
                echo $this->Form->end($options);
                ?>
            </div>
        </div> 
