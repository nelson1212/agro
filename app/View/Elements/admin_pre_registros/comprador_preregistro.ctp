...
<div class="panel panel-default" id="divPanel"> 
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                    <?php echo $this->Form->input('ubicacion', array("div" => false, "options" => $ubicaciones, "id" => "cboUbicacionesPre", "label" => "Ubicación*", 'tag' => 'ubicacion', "type" => "select", "class" => "form-control")); ?>
