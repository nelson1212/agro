...
<div class="panel panel-default" id="divPanel"> 
    ...
    <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        <?php echo $this->Form->input('paiss_id', array("div" => false, "options" => $paisses, "id" => "cboPaisesPre", "label" => "Paises *", 'tag' => 'paiss_id', "type" => "select", "class" => "form-control")); ?>
                ...
                <div class="col-lg-4" id="">
                    <div class="form-group">
                        <?php echo $this->Form->input('ciudad', array("div" => false,  "id" => "txtCiudad", 'tag' => 'ciudad', "label" => "Ciudad *", "type" => "text", "class" => "form-control")); ?>
