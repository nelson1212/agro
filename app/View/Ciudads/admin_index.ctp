<div class="ciudads index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $ciudad['Ciudad']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $ciudad['Ciudad']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
