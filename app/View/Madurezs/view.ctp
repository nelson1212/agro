<div class="madurezs view">
<h2><?php echo __('Madurez'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($madurez['Madurez']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($madurez['Madurez']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Madurez'), array('action' => 'edit', $madurez['Madurez']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Madurez'), array('action' => 'delete', $madurez['Madurez']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $madurez['Madurez']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Madurezs'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Madurez'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($madurez['Producto'] as $producto): ?>
		<tr>
