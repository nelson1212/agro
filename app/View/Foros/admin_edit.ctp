...
<?php echo $this->Form->create('Foro'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Foro'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Foro.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Foro.id')))); ?></li>
