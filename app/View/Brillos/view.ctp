<div class="brillos view">
<h2><?php echo __('Brillo'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($brillo['Brillo']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($brillo['Brillo']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Brillo'), array('action' => 'edit', $brillo['Brillo']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Brillo'), array('action' => 'delete', $brillo['Brillo']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $brillo['Brillo']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Brillos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Brillo'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($brillo['Producto'] as $producto): ?>
		<tr>
