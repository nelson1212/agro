...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Paiss'), array('action' => 'edit', $paiss['Paiss']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Paiss'), array('action' => 'delete', $paiss['Paiss']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $paiss['Paiss']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Paisses'), array('action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($paiss['User'] as $user): ?>
		<tr>
