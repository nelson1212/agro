<div class="embalajes view">
<h2><?php echo __('Embalaje'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($embalaje['Embalaje']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($embalaje['Embalaje']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Embalaje'), array('action' => 'edit', $embalaje['Embalaje']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Embalaje'), array('action' => 'delete', $embalaje['Embalaje']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $embalaje['Embalaje']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Embalajes'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Embalaje'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($embalaje['Producto'])): ?>
	...
	<?php foreach ($embalaje['Producto'] as $producto): ?>
		<tr>
