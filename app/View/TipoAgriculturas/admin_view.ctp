<div class="tipoAgriculturas view">
<h2><?php echo __('Tipo Agricultura'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($tipoAgricultura['TipoAgricultura']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($tipoAgricultura['TipoAgricultura']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipo Agricultura'), array('action' => 'edit', $tipoAgricultura['TipoAgricultura']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tipo Agricultura'), array('action' => 'delete', $tipoAgricultura['TipoAgricultura']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $tipoAgricultura['TipoAgricultura']['id']))); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($tipoAgricultura['User'])): ?>
	...
	<?php foreach ($tipoAgricultura['User'] as $user): ?>
		<tr>
