<div class="calidads view">
<h2><?php echo __('Calidad'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($calidad['Calidad']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($calidad['Calidad']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Calidad'), array('action' => 'edit', $calidad['Calidad']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Calidad'), array('action' => 'delete', $calidad['Calidad']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $calidad['Calidad']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Calidads'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Calidad'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($calidad['Producto'] as $producto): ?>
		<tr>
