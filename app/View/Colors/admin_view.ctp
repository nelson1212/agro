...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Color'), array('action' => 'delete', $color['Color']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $color['Color']['id']))); ?> </li>
...
<div class="related">
	...
	<?php foreach ($color['Producto'] as $producto): ?>
		<tr>
