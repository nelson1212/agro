<div class="colors index">
	...
	<tr>
		...
		<td><?php echo h($color['Color']['nombre']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $color['Color']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $color['Color']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
