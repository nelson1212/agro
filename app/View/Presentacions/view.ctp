<div class="presentacions view">
<h2><?php echo __('Presentacion'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($presentacion['Presentacion']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($presentacion['Presentacion']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Presentacion'), array('action' => 'edit', $presentacion['Presentacion']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Presentacion'), array('action' => 'delete', $presentacion['Presentacion']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $presentacion['Presentacion']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Presentacions'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Presentacion'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($presentacion['Producto'])): ?>
