<div class="lavados view">
<h2><?php echo __('Lavado'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($lavado['Lavado']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nombre'); ?></dt>
		<dd>
			<?php echo h($lavado['Lavado']['nombre']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Lavado'), array('action' => 'edit', $lavado['Lavado']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Lavado'), array('action' => 'delete', $lavado['Lavado']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $lavado['Lavado']['id']))); ?> </li>
		<li><?php echo $this->Html->link(__('List Lavados'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Lavado'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($lavado['Producto'] as $producto): ?>
		<tr>
